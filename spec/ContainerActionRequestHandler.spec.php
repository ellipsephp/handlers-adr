...
use Ellipse\Handlers\ContainerActionRequestHandler;
...
describe('ContainerActionRequestHandler', function () {

    beforeEach(function () {

        $this->container = mock(ContainerInterface::class);

        $this->handler = new ContainerActionRequestHandler($this->container->get(), 'Domain', 'Responder', [
            'k1' => 'v1.default',
            'k2' => 'v2.default',
        ]);
    ...
    describe('->handle()', function () {
        ...
        context('when the domain retrieved from the container is an object implementing DomainInterface', function () {
            ...
            context('when the responder retrieved from the container is an object implementing ResponderInterface', function () {
                ...
                it('should proxy an ActionRequestHandler', function () {
